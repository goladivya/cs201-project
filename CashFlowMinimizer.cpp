...
class bank{      //class containing information of banks
    public:
    string name;
    int netAmount;
    set<string> types;
...
//This function is to get the min netAmount among the all banks 
...
//This function is to get the max netAmount among the all banks 
